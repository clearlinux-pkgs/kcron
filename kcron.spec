...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kcron-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kcron-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kcron-22.04.3
cd %{_builddir}/kcron-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657576099
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcron-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kcron/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kcron-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcron/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kcron
