...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kcron-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kcron-24.12.1.tar.xz.sig
...
%setup -q -n kcron-24.12.1
cd %{_builddir}/kcron-24.12.1
pushd ..
cp -a kcron-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736549161
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt6/plugins/plasma/kcms/systemsettings/kcm_cron.so
/usr/lib64/qt6/plugins/plasma/kcms/systemsettings/kcm_cron.so
