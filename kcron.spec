...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kcron-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kcron-24.12.2.tar.xz.sig
...
%setup -q -n kcron-24.12.2
cd %{_builddir}/kcron-24.12.2
pushd ..
cp -a kcron-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738978396
mkdir -p clr-build
pushd clr-build
