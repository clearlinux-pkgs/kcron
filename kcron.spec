...
Version  : 22.08.0
Release  : 42
URL      : https://download.kde.org/stable/release-service/22.08.0/src/kcron-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kcron-22.08.0.tar.xz
...
%prep
%setup -q -n kcron-22.08.0
cd %{_builddir}/kcron-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661550549
mkdir -p clr-build
pushd clr-build
