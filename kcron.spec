...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kcron-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kcron-24.08.1.tar.xz.sig
...
%setup -q -n kcron-24.08.1
cd %{_builddir}/kcron-24.08.1
pushd ..
cp -a kcron-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726192477
mkdir -p clr-build
pushd clr-build
